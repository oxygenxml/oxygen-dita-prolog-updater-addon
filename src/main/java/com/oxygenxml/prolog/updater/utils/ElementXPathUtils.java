...
public class ElementXPathUtils {
  ...
  public static String getPrologXpath(DocumentType documentType) {
    return documentType.equals(DocumentType.TOPIC) ? ElementXPathConstants.PROLOG_XPATH : ElementXPathConstants.TOPICMETA_XPATH;
  }
  ...
  public static String getAuthorCreatorXpath(DocumentType documentType) {
    return documentType.equals(DocumentType.TOPIC) ? ElementXPathConstants.PROLOG_AUTHORS_CREATOR : ElementXPathConstants.TOPICMETA_AUTHORS_CREATOR;
  }
